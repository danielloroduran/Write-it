      ...
      body: new ListView(
        children: <Widget>[
          ...
          AnimatedContainer(
              ...
              child: _nota.urlImagen != "" || _nota.urlImagen != null
                  ? Image(image: NetworkImage(_nota.urlImagen))
                  : _imagen != null
                      ? Image.file(_imagen)
                      : null
      ...
      floatingActionButton: Row(
        ...
        children: <Widget>[
          ...
          FloatingActionButton.extended(
            ...
            tooltip: _imagen != null || _nota.urlImagen != ""
                ? "Modificar foto"
                : "Añadir foto",
            label: _imagen != null || _nota.urlImagen != ""
                ? Text("Modificar foto")
                : Text("Añadir foto"),
        ...
        child: Container(
          ...
          child: Row(
            children: <Widget>[
              ...
              IconButton(
                icon: Icon(
                    _nota.importante == true ? Icons.flag : Icons.outlined_flag,
                    color: _nota.importante == true
                        ? Colors.red
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content:
                new Text("Hay cambios sin guardar. ¿Seguro que quieres salir?",
                    style: TextStyle(
                      color: Theme.of(context).primaryColor,
                    )),
            actions: <Widget>[
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content:
                new Text("Estás a punto de eliminar esta nota. ¿Continuar?",
                    style: TextStyle(
                      color: Theme.of(context).primaryColor,
                    )),
            actions: <Widget>[
  ...
  void _guardarNota() async {
    ...
    if (_esNotaNueva) {
      ...
      notaNueva.then((valor) {
        setState(() {
          _nota = Nota.fromMap(valor.data(), valor.id);
        });
      });
      ...
      if (_nota.pathImagen == "" && _nota.urlImagen == "" && _imagen != null) {
        ...
        _nota.urlImagen = url;
        _nota.pathImagen = widget.uid + "/" + _nota.id + ".jpg";
      } else if (_nota.pathImagen != "" &&
          _nota.urlImagen != "" &&
          _imagen != null) {
        widget.ss.borrarFotoNota(_nota.pathImagen);
        url = await widget.ss.subirFotoNota(_imagen, _nota);
        _nota.urlImagen = url;
      } else if ((_nota.pathImagen == "" || _nota.pathImagen != "") &&
          _imagen == null) {
        widget.ss.borrarFotoNota(_nota.pathImagen);
        _nota.pathImagen = "";
        _nota.urlImagen = "";
